...
class Apparate:
    ...
    def __init__(self):
        ...
        try:
            ...
            if hasattr(e, '_GithubException__status') and e._GithubException__status == 401:  # unauthorized                
        ...
        try:
            ...
            if hasattr(e, '_GithubException__status') and e._GithubException__status == 404:                
    ...
    def update_submissions(self, submissions):
        try:
            ...
            self.repo.update_file("submissions.txt", "updated submissions.txt", pickle.dumps(submissions + self.submissions), c.sha)
